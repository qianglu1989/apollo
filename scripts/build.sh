...
apollo.defalue.user=luqiang
apollo.defalue.admin=luqiang,liqiuwei,apollo
...
mvn clean package -DskipTests -pl apollo-portal -am -Dapollo_profile=github,auth -Dspring_datasource_url=$apollo_portal_db_url -Dspring_datasource_username=$apollo_portal_db_username -Dspring_datasource_password=$apollo_portal_db_password -Dspring_kafka_bootstrap=$spring_kafka_bootstrap -Dapollo.defalue.user=$apollo.defalue.user -Dapollo.defalue.admin=$apollo.defalue.admin $META_SERVERS_OPTS
